...
export class GameCinema2Service {
    ...
    async getTodayGame(user: {
        ...
        return this.rpc.send<{ userId: number }, GameData>(
            ...
            { userId: user.id },
            {
                ...
                origin: "GameCinema2Service.getTodayGame",
            }
        );
    }
    ...
    async getGameByDate(
        ...
        return this.rpc.send<{ userId: number; date: string }, GameData>(
            ...
            { userId: user.id, date },
            {
                userId: user.id.toString(),
                username: user.username,
                origin: "GameCinema2Service.getGameByDate",
            }
        );
    }
    ...
    async submitGuess(
        ...
        >(
            ...
            { userId: user.id, guess, date },
            {
                userId: user.id.toString(),
                username: user.username,
                origin: "GameCinema2Service.submitGuess",
            }
        );
    }
    ...
    async searchMovie(
        ...
        >(
            ...
            { query },
            {
                origin: "GameCinema2Service.searchMovie",
            }
        );
    }
    ...
    async getGameResult(
        ...
        >(
            ...
            { userId: user.id, date },
            {
                userId: user.id.toString(),
                username: user.username,
                origin: "GameCinema2Service.getGameResult",
            }
        );
    }
    ...
    async getUserResultsByMonth(
        ...
        return this.rpc.send<{ userId: number; month: string }, GameResult[]>(
            ...
            { userId: user.id, month },
            {
                userId: user.id.toString(),
                username: user.username,
                origin: "GameCinema2Service.getUserResultsByMonth",
            }
        );
    }
}
