...
export default function GameFailed({
    ...
    return (
        ...
        <>
            <div className={`flex gap-4 items-center justify-between  flex-wrap ${isCurrentUser ? 'current-user' : ''}`}>
                <div className="flex gap-2 items-center">
                    ...
                    <div className="flex flex-col">
                        <div className="flex items-center gap-1 gap-y-0 flex-wrap"><div className="flex-shrink-0 block md:hidden">
                            {showAvatar ? (<Image
                                src={user.avatarUrl ||
                                    `/assets/avatar/avatar-default-${Math.floor(Math.random() * 7 + 1)}.png`}
                                width={20}
