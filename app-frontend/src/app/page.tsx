  ...
  return (<>
    ...
    <div className="w-full py-6">
      ...
      <div className="flex flex-col items-center text-center">
        ...
        <PageSubtitle>
          Cinéma, géographie, culture générale... Un nouveau challenge t’attend chaque jour pour tester tes connaissances et grimper dans les classements !
        </PageSubtitle>

        {
          !session &&
          <p className="font-semibold mb-6">
            Rejoins la communauté dès maintenant pour débloquer des récompenses exclusives, suivre ta progression et affronter tes amis !
          </p>
        }
